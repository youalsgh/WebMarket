...
<body>
	...
	<div class="container">
		<form action="processAddMember.jsp" name="newMember" class="form-horizontal" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4 form-inline">
					...
					<input type="text" name="birthdd" class="form-control" maxlength="2" placeholder="일" size="4">
				</div>
			</div>
